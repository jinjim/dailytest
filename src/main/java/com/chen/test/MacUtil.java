...
public class MacUtil {
    ...
    public static String ASC_2_HEX(String asc) {
        ...
        try {
            ...
            for (byte b : bs) {
                hex.append(Integer.toHexString((b & 0x000000FF) | 0xFFFFFF00).substring(6) );
            }
...
//		String a = "|123|876222|中文|aaaaaaa|中文|1299";
        String a = "credit002|";
        // MAC(String key, String vector, String data, int type)
        String mac = MAC("C5B2A628A7B9E3B2", "0000000000000000", "000213<?xml version=\"1.0\" encoding=\"GB2312\"?>\n" +
                "<Root>\n" +
                "  <Head>\n" +
                "    <RespCode>10001</RespCode>\n" +
                "    <RespMsg>系统内部错误</RespMsg>\n" +
                "    <OrgBusiDate>20161018</OrgBusiDate>\n" +
                "    <OrgSeqNo/>\n" +
                "  </Head>\n" +
                "</Root>\n" +
                "  ", ASC);
