...
public class MacEcbUtils {
	...
	public String calcMacStr(String macKey, String macStr) {
		...
		String macValueStr1 = bytesToHexString(macValue).substring(0, 16);
		System.out.println("macValueStr1:" + macValueStr1);
		String macValueStr = HexUtil.encodeHexStr(macValue);
		System.out.println("macValueStr2:" + macValueStr);
		return macValueStr;
	}

	public static void main(String[] args) {
		String key = "FAB943F4E7F4FDE1";
		String context = "hellowsddfsdffffff测试leifffffffsdfsdfsdforld";
